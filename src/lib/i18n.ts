...
const en: TranslationMap = {
  ...
  "nav.barcode_scanner": "Barcode Scanner", "nav.pos_receipt": "POS Receipt", "nav.customer_portal": "Customer Portal",
...
const hi: TranslationMap = {
  ...
  "nav.barcode_scanner": "बारकोड स्कैनर", "nav.pos_receipt": "POS रसीद", "nav.customer_portal": "ग्राहक पोर्टल",
...
const bn: TranslationMap = {
  ...
  "nav.barcode_scanner": "বারকোড স্ক্যানার", "nav.pos_receipt": "POS রসিদ", "nav.customer_portal": "গ্রাহক পোর্টাল",
...
const gu: TranslationMap = {
  ...
  "nav.barcode_scanner": "બારકોડ સ્કેનર", "nav.pos_receipt": "POS રસીદ", "nav.customer_portal": "ગ્રાહક પોર્ટલ",
...
const mr: TranslationMap = {
  ...
  "nav.barcode_scanner": "बारकोड स्कॅनर", "nav.pos_receipt": "POS पावती", "nav.customer_portal": "ग्राहक पोर्टल",
...
const ta: TranslationMap = {
  ...
  "nav.barcode_scanner": "பார்கோடு ஸ்கேனர்", "nav.pos_receipt": "POS ரசீது", "nav.customer_portal": "வாடிக்கையாளர் போர்ட்டல்",
