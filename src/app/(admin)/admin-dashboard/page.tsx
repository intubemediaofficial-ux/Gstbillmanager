...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "Total Clients", value: data?.totalClients || 0, icon: Users, color: "bg-blue-500" },
    { label: "Total Invoices", value: data?.totalInvoices || 0, icon: FileText, color: "bg-green-500" },
    { label: "Total Revenue", value: formatCurrency(data?.totalRevenue || 0), icon: IndianRupee, color: "bg-purple-500" },
    { label: "Pending Amount", value: formatCurrency(data?.totalPending || 0), icon: Clock, color: "bg-orange-500" },
  ];
